    ...
    <div className="max-w-4xl w-full mx-auto grid grid-cols-1 md:grid-cols-12 gap-6">
      ...
      <div className="col-span-1 md:col-span-12 text-center mb-2 flex flex-col items-center">
        <div className="flex items-center gap-3 mb-3">
          <span className="font-sans text-2xl font-bold text-gray-900">LodgeOS</span>
        ...
        <h1 className="text-3xl font-bold text-gray-900 font-sans mb-2">
      ...
      <div className="col-span-1 md:col-span-7 bg-white rounded-2xl border border-gray-100 p-8 shadow-sm flex flex-col justify-center items-center text-center relative overflow-hidden group">
        <div className="w-16 h-16 bg-[#0b1437] text-white rounded-2xl flex items-center justify-center mb-5 shadow-sm">
          <Monitor className="w-8 h-8" />
        </div>
        <h2 className="text-xl font-bold text-gray-900 mb-1.5 font-sans">Desktop Client App</h2>
        ...
        <a
          ...
          className="bg-[#0b1437] text-white text-xs font-bold px-7 py-3 rounded-xl hover:bg-[#162268] transition-colors duration-200 flex items-center gap-2 w-full sm:w-auto justify-center shadow-sm"
        >
      ...
      <div className="col-span-1 md:col-span-5 bg-gray-50/70 rounded-2xl border border-gray-100 p-8 shadow-sm flex flex-col justify-between">
        <div>
